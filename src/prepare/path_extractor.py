...
def main():
    ...
    print("compiled ones ************:",compiled)
    print("Uncompiled ones ___________:",uncompiled)
    ...
    print("Extracting paths for all programs in the csv file. Output is [[start,path_hash/path,end,...,...],...].")
